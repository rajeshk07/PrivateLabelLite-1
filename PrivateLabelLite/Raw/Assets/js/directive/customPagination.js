(function () {
    ...
    <div ng-hide=" !totalRecords || totalRecords <= pageSize$" class="row form top-border-gray-1">\
        ...
        <div  class="col-md-3 col-xs-12 text-right margin-top-sm">\
            ...
            <label class="control-label top-padding-10">Total Products: <span class="text-bold" ng-bind="totalRecords"></span></label>\
        </div>\
    </div>\
   <div ng-if ="totalRecords <= pageSize$ && totalRecords >= 1" class="pull-right"><label class="control-label top-padding-10">Total Products: <span class="text-bold" ng-bind="totalRecords"></span></label></div>\
 <div ng-if ="totalRecords == 0 || !totalRecords" class="pull-left"><label class="text-muted top-padding-10">No Product Found</label></div>\
</div>',
            link: function (scope) {
            },
