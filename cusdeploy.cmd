...
:end
echo rajesh kareti
	Powershell.exe -NoProfile -executionpolicy Bypass -Command -File  ".\home\site\wwwroot\customscript.ps1 --Target=Kudu-Deploy|Out-String -Stream; exit $LastExitCode;"
